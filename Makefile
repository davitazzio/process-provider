# ====================================================================================
# Setup Project
PROJECT_NAME := provider-processprovider
...
IMAGES = provider-processprovider
...
XPKGS = provider-processprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-processprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ProcessProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ProcessProvider controllers
...
# This target prepares repo for your provider by replacing all "processprovider"
